const WEATHER_API_KEY = '7c7b65194007148d928bcdff9f5e0dcb'
	const headers = {
	  ...
	  data
	    ...
	    .forEach(country => {
	      ...
	      countryContainer.innerHTML += `
	        <tr>
	          <td>
	            <button class="btn-remove-country" data-code="${code}">delete</button>
	            <button class="btn-update-country" data-code="${code}" data-country='${JSON.stringify(country)}'>update</button>
	          </td>
