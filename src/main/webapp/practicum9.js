...
function addLogin() {
    modal.style.display = "block";
    document.getElementById("wijzigGegevens").innerHTML = '<p1>Username </p1><input id="username" name="username" type=" text" value=""><br><br>';
    document.getElementById("wijzigGegevens").innerHTML += '<p1>Password </p1><input id="password" name="password" type="password" value=""><br><br>';
